...
/* ========================= ORNAMENT DATA ========================= */ 
const ORNAMENTS = { star: { img: "star.png", wish: "My lighthouse, my anchor, and my safe place. I miss you so much baby." }, 
...
const ORNAMENT_POSITIONS = { star: { x: 45, y: 70 }, 
                            red: { x: 38, y: 30 }, 
                            blue: { x: 56, y: 20 }, 
                            candy: { x: 50, y: 48 }, 
                            bell: { x: 70, y: 42 }, 
...
function pctToPx(xPct, yPct) { 
   ...
   return { left: (xPct / 100) * r.width, top: (yPct / 100) * r.height }; } 
/* ========================= WISH BUBBLE ========================= */ 
function showWish(el, text) { 
   bubbleText.textContent = text; 
   bubble.hidden = false; const r = el.getBoundingClientRect(); 
